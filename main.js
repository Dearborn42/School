// let userName = prompt("Email of victim");
                            ...
                            for(let b=0; b<user.length; b++){
                                for(let l=0; l<user.length; l++){
                                    for(let t=0; t<user.length; t++){
                                        ...
                                        user[7] = code[l];
                                        user[8] = code[t];
                                        console.log(user[0]+user[1]+user[3]+user[4]+user[5]+user[6]+user[7]+user[8]+user[9]);
                                    }
                                }
                            }
                        }
            ...
            for(let i=0; i<year.length; i++){
               for(let x=0; x<month.length; x++){
                    for(let y=0; y<day.length; y++){
                        ...
                        password[2] = day[y];
                        password[3] = year[i];
                        console.log(password[0]+password[1]+password[2]+password[3]);
                    }
                }
            }
        }
